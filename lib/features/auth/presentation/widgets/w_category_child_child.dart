  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ListTile(
          ...
          title: Row(
            children: [
              ...
              Text(
                'widget.widget.state.categories[widget.widget.categoryId].childs[widget.categoryId].name',
        ...
        //   shrinkWrap: true,
        //   itemCount: (widget.widget.state.categories[widget.widget.categoryId].childs[widget.categoryId].childs as List)
        //       .length,
        //   itemBuilder: (context, index) {
        //     final item = (widget.widget.state.categories[widget.widget.categoryId].childs[widget.categoryId].childs
        //         as List)[index];
        //
        //     return ListTile(
        //       title: WSelectItem(
        ...
        Padding(
          ...
          child: WElevatedButton(
            onPressed: () {
              // context.read<CategoryBloc>().add(CategoryEvent(groupValue, categoryId));
